...
<head>
  ...
  <!----======== CSS ======== -->
  <link rel="stylesheet" href="{{ asset('agrocefa/master/css/style.css') }}">
  <link rel="stylesheet" href="{{ asset('agrocefa/master/css/estilos.css') }}">
  <link rel="stylesheet" href="{{ asset('agrocefa/master/css/navbar.css') }}">
  <link rel="stylesheet" href="{{ asset('agrocefa/master/css/footer.css') }}">
  <link rel="stylesheet" href="{{ asset('agrocefa/master/css/target.css') }}">
  <link rel="stylesheet" href="{{ asset('agrocefa/master/css/stilos.css') }}">
